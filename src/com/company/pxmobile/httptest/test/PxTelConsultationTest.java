...
public class PxTelConsultationTest extends AbstractHttpTest {
  ...
  public static void main(String args[]) throws Exception {
    ...
    PxTelConsultationTest o=new PxTelConsultationTest();
   // o.testSaveSuccess();
  //  o.testappraise();
    o.testSaveSuccess();
  ...
  public static Test suite() {
      return new TestSuite( PxTelConsultationTest.class );
  }
...
//      assertTrue( "Login not rejected", response.getText().indexOf( "Login failed" ) != -1 );
	...
	public void testSaveSuccess() throws Exception {
		...
		PxTelConsultationJsonform s = new PxTelConsultationJsonform();
...
//		s.setContent("3很好!很好!很好!很好!很好!很好!很好!");
		...
		PostMethodWebRequest request = new PostMethodWebRequest(
				TestConstants.host + "rest/pxTelConsultation/save.json"+user.addParameter_JSESSIONID(), input,
